    ...
    children: [
      ...
      //信息审核
      {
        ...
        children: [
          ...
          //线上培训审核
          {
            path: '/examine/audit_online',
            component: () => import('@/views/system/onlineTraining/audit'),
            hidden: true
          },
          //专家审核
          {
            path: '/examine/audit_expert',
            component: () => import('@/views/system/expert/audit'),
            hidden: true
          },
        ]
      },
    ...
    children: [
      ...
      // 信息审核
      {
        ...
        children: [
          //优品审核
          {
            path: '/audit/audit_products',
            component: () => import('@/views/system/products/audit'),
            hidden: true
          },
          //渠道审核
          {
            path: '/audit/audit_channel',
            component: () => import('@/views/system/channel/audit'),
            hidden: true
          },
          //新品种审核
          {
            path: '/audit/audit_species',
            component: () => import('@/views/system/species/audit'),
            hidden: true
          },
          //学农技审核
          {
            path: '/audit/audit_tech',
            component: () => import('@/views/system/tech/audit'),
            hidden: true
          },
          //买农资审核
          {
            path: '/audit/audit_farm',
            component: () => import('@/views/system/farm/audit'),
            hidden: true
          },
          //随时问审核
          {
            path: '/audit/audit_free',
            component: () => import('@/views/system/free/audit'),
            hidden: true
          },
          //评论/问答审核
          {
            path: '/audit/audit_question',
            component: () => import('@/views/system/question/audit'),
            hidden: true
          },
          {
            path: '/audit/station_audit',
