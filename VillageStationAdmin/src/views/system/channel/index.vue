  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="140px">
        <el-form-item label="一级栏目编码" prop="firstColumn">
          <el-select v-model="queryParams.firstColumn" placeholder="请选择一级栏目编码">
    ...
    <el-dialog :title="title" :visible.sync="open" width="1400px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="审核标志" prop="firstColumn">
          <el-input v-model="form.firstColumn"/>
        </el-form-item>
        <!-- <el-form-item label="排序" prop="sort">
...
export default {
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      getChannel(newsId).then(response => {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除找渠道编号为"' + newsIds + '"的数据项？').then(function() {
        return delChannel(newsIds);
      }).then(() => {
        this.getList();
