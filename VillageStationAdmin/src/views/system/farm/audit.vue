<template>
  <div class="app-container">
    ...
    <el-table-column type="selection" width="55" align="center" />
      ...
      <el-table-column label="农资类型" align="center" prop="secondColumn" :formatter="showType"/>
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button
            ...
            v-hasPermi="['system:farm:list:unchecked']"
          >详情</el-button>
          <el-button
            size="mini"
            type="text"
...
<script>
import {checkFarm,listFirstColums,delFarm, addFarm} from "@/api/system/farm";
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.newsId != null) {
            checkFarm(this.form).then(response => {
              this.$modal.msgSuccess("修改成功");
              this.open = false;
              this.getList();
            });
