<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="farmList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="一级栏目编码" align="center" prop="firstColumn" :formatter="showType2"/>
      <el-table-column label="二级栏目编码" align="center" prop="secondColumn" :formatter="showType"/>
      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="二级栏目编码" prop="secondColumn">
          <el-select v-model="form.secondColumn" placeholder="请选择二级栏目编码" width="1300px">
            <el-option label="节肥增效" value="0"></el-option>
            <el-option label="虫害防控" value="1"></el-option>
            <el-option label="农机装备" value="2"></el-option>
            <el-option label="种子树苗" value="3"></el-option>
          </el-select>
        </el-form-item>
        <!-- <el-form-item label="排序" prop="sort">
...
<script>
import { listFarm, getFarm, delFarm, addFarm, updateFarm } from "@/api/system/farm";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除买农资编号为"' + newsIds + '"的数据项？').then(function() {
        return delFarm(newsIds);
      }).then(() => {
        this.getList();
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('system/farm/export', {
        ...this.queryParams
