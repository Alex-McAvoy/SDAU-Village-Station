<template>
  <div>
    ...
    <div class="inputItem" style="display:flex;margin:5px 50px 5px 5px; ">
      <el-button style="background: #fff;border:0px;width:100px">金融类型</el-button>
      <el-select v-model="form.secondColumn" placeholder="请选择金融类型">
...
import { addFinance} from "@/api/system/finance";
