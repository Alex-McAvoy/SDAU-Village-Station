...
<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="financeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="金融类型" align="center" prop="secondColumn" :formatter="showType"/>
    ...
    <el-dialog :title="title" :visible.sync="open" width="1400px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="审核标志" prop="firstColumn">
          <el-input v-model="form.firstColumn" :disabled="formDisabled"/>
        </el-form-item>
        <el-form-item label="金融类型" prop="secondColumn" width="1300px">
