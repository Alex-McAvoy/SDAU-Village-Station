      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button
            ...
            v-hasPermi="['system:free:list:unchecked']"
          >详情</el-button>
          <el-button
            size="mini"
            type="text"
     ...
     <template>
          <el-dialog :title="title" :visible.sync="open" width="1400px" append-to-body>
            <el-form ref="form" :model="form" :rules="rules" label-width="80px">
                ...
                <el-input v-model="form.createBy" type="textarea" :disabled="formDisabled"/>
                </el-form-item>
...
<script>
import {checkFree, delFree, addFree,listFirstColums} from "@/api/system/free";
