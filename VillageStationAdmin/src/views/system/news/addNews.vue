<template>
  <div>
    ...
    <div class="inputItem" style="display:flex;margin:5px 50px 5px 5px; ">
      ...
      <el-select v-model="form.audit" placeholder="请选择一级栏目编码">
      </el-select> -->
      <el-button style="background: #fff;border:0px;width:100px">新闻类型</el-button>
...
import { addColumns } from "@/api/news/index";
  ...
  methods: {
    ...
    handleUploadError() {
      ...
      addColumns(this.form).then(response => {
        ...
        this.open = false;
        this.$router.push('/station/submit/submit');
      });
    }
  },
};
