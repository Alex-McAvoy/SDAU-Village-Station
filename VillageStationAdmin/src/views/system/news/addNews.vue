<template>
  <div>
    <div class="inputItem" style="display:grid;grid-template-columns: auto 3fr 1fr  ;margin:10px 50px 5px 5px ">
      ...
      <el-input  style="grid-column:2/3;margin-right: 100px;" v-model="form.input" placeholder="请输入内容" label="标题"></el-input>
    ...
    <div class="inputItem" style="display:flex;margin:5px 50px 5px 5px; ">
      <el-button style="background: #fff;border:0px;width:100px" >一级类别</el-button>
      ...
      <el-button style="background: #fff;border:0px;width:100px">二级类别</el-button>
      <el-select v-model="form.secondColumn" placeholder="请选择一级栏目编码">
          <el-option label="新闻资讯" value="1"></el-option>
          <el-option label="金融资讯" value="2"></el-option>
      </el-select>
    </div>
    <div class="inputItem" style="display:flex;margin:5px 50px 5px 5px ">
    </div> 
...
import { addColumns } from "@/api/system/news";
