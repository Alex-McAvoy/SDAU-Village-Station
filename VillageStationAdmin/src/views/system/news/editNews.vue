<template>
  <div>
    ...
    <div class="inputItem" style="display:flex;margin:5px 50px 5px 5px; ">
      <el-button style="background: #fff;border:0px;width:100px"><span style="color:red">* </span>新闻类型</el-button>
...
import {  addColumns, updateColumns } from "@/api/news/index";
...
export default {
  ...
  created(){
    this.form = JSON.parse(localStorage.getItem("editNews"))
  ...
  methods: {
    ...
    submitForm(){
      ...
      updateColumns(this.form).then(response => { 
        ...
        this.open = false;
        this.$router.push('/information/submit/news');
      });
    },
    init() {
