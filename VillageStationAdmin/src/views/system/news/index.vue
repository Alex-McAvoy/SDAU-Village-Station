<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="columnsList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="审核标志" align="center" prop="firstColumn" :formatter="showType"/>
      <el-table-column label="新闻类型" align="center" prop="secondColumn" :formatter="showType2"/>
    ...
    <el-dialog :title="title" :visible.sync="open" width="1400px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="审核标志" prop="firstColumn">
          <el-input v-model="form.firstColumn" type="textarea" />
        </el-form-item>
        <el-form-item label="新闻类型" prop="secondColumn" width="1300px">
