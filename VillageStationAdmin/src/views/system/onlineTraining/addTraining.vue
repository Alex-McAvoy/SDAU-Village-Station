...
            <el-option label="农机" value="11"></el-option>
    ...
    <div class="upload_row">
      ...
      <el-upload v-show="uploadVideo.uiShow" ref="upload" :limit="1" accept=".mp4" :action="uploadVideo.url"
        :headers="uploadVideo.headers" list-type="picture-card" 
        :before-upload="handleBeforeVideoUpload" :on-progress="handleUploadProgress"
    ...
    <!-- 编辑器  -->
    <el-upload :action="uploadUrl" :before-upload="handleBeforeImageUpload" :on-success="handleUploadSuccess"
...
import { addTraining, addTrainingVideo } from "@/api/onlineTraining/index";
