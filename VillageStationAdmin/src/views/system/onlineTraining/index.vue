<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="ontrainingList" @selection-change="handleSelectionChange">
      ...
      <!-- <el-table-column label="培训类型" align="center" prop="category" :formatter="showType"/> -->
    ...
    <el-dialog :title="title" :visible.sync="open" width="1400px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="审核标志" prop="audit" :disabled="formDisabled">
          <el-input v-model="form.audit"/>
        </el-form-item>
        <!-- <el-form-item label="培训类型" prop="category">
          <el-input v-model="form.category" placeholder="请选择培训类型">
          </el-input>
        </el-form-item> -->
        <el-form-item label="排序" prop="sort">
...
<script>
import { listTraining, getTraining, delTraining, addTraining, updateTraining } from "@/api/onlineTraining/index";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除线上培训编号为"' + ids + '"的数据项？').then(function() {
