    ...
    <el-table v-loading="loading" :data="productsList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        ...
        <el-button
            ...
            v-hasPermi="['system:products:list:unchecked']"
        >详情</el-button>
          <el-button
            size="mini"
            type="text"
            ...
            v-hasPermi="['system:products:check']"
          >通过</el-button>
          <el-button
            size="mini"
            type="text"
...
<script>
import { delProducts, checkProducts,listFirstColums} from "@/api/system/products";
...
export default {
  ...
  methods: {
    ...
    handlePass(row) {
      row.firstColumn = 1;
      checkProducts(row).then(response => {
