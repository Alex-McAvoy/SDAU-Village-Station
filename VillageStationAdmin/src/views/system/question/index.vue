  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="open" width="1400px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="问题/评论" prop="parentId" width="1300px">
          <el-select v-model="form.parentId" placeholder="请选择类型">
            <el-option label="问题" value="0"></el-option>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除评论/问答编号为"' + questionIds + '"的数据项？').then(function() {
