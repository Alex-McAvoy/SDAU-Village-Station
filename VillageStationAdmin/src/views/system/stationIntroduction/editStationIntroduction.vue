<template>
  <div>
    ...
    <div class="inputItem" style="display:flex;margin:5px 50px 5px 5px; ">
      ...
      <el-select v-model="form.category" multiple value-key="value" placeholder="请选择标签" required>
...
import {  addColumns, updateColumns } from "@/api/stationIntroduction/index";
...
export default {
  ...
  data() {
    ...
    this.form = JSON.parse(localStorage.getItem("editStationIntroduction"))
  ...
  methods: {
    ...
    //提交修改
    submitForm(){
      if (this.form.category == undefined|| this.form.category == ""|| this.form.category == null) {
