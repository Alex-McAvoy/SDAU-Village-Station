<template>
  <div class="app-container">
    ...
    <el-table-column type="selection" width="55" align="center" />
      ...
      <el-table-column label="农技类型" align="center" prop="secondColumn" :formatter="showType"/>
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button
            ...
            v-hasPermi="['system:tech:list:unchecked']"
          >详情</el-button>
          <el-button
            size="mini"
            type="text"
     ...
     <template>
          <el-dialog :title="title" :visible.sync="open" width="1400px" append-to-body>
            <el-form ref="form" :model="form" :rules="rules" label-width="80px">
                ...
                <el-input v-model="form.title" type="textarea" placeholder="请输入内容" :disabled="formDisabled"/>
                </el-form-item>
...
<script>
import {checkTech,listFirstColums,delTech, addTech} from "@/api/system/tech";
...
export default {
  ...
  methods: {
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.newsId != null) {
            checkTech(this.form).then(response => {
              this.$modal.msgSuccess("修改成功");
              this.open = false;
              this.getList();
            });
    ...
    showType(str){
      ...
      var list=['水稻','小麦','蔬菜','果树','植保','禽畜','农机','水产'];
