<template>
  <div>
    ...
    <div class="title_row"style="display:flex;margin:5px 50px 5px 5px; ">
      ...
      <el-button type="primary" class="release" icon="el-icon-upload2" @click="submit">修改</el-button>
    </div>
    <!-- 推荐标签 -->
...
import {  updateTraining } from "@/api/offlineTraining/index";
  ...
  data() {
    return {
      ...
      uploadImg: {
        ...
        this.form = JSON.parse(localStorage.getItem("editOfflineTraining")) 
