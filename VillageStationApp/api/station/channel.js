...
// 查询已审核的分类渠道
export function getChannelListByColumns(firstColumn,secondColumn,sort) { 
  return request({
    url: '/system/channel/getListByColumn/' + firstColumn+'/'+secondColumn + '/' + sort,
    method: 'get'
  })
}
