...
// 查询已审核的分类农资
export function getFarmListByColumn(firstColumn, secondColumn,sort) { 
  return request({
    url: '/system/farm/getListByColumn/' + firstColumn+'/'+secondColumn + '/' + sort,
    method: 'get'
  })
}
...
export function queryFarm(query) {
	return request({
		url: '/system/farm/like/' + query,
		method: 'get',
	})
}
