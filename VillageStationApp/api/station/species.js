...
// 查询已审核的分类农资
export function getSpeciesListByColumn(firstColumn,sort) {
	return request({
		url: '/system/species/getListByColumn/' + firstColumn + '/' + sort,
		method: 'get'
	})
}
...
export function querySpecies(query) {
	return request({
		url: '/system/species/like/' + query,
		method: 'get',
	})
}