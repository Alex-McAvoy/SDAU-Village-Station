<template>
	<view class="body">
		...
		<view style="border-radius: 10px; background-color: white;margin:15px;">
			...
			<view class="news" v-for="item in productList" @click="goResDetail(item,2)">
				<view class="new_img">
					<image :src="item.remark" alt="" style="width:100%;height: 70px;overflow: hidden">
				</view>
				<view class="new_title">{{ item.title }}</view>
			...
			<view class="news" v-for="item in expertList" @click="goResDetail(item,3)">
				<view class="new_img">
					<image :src="item.remark" alt="" style="width:100%;height: 70px;overflow: hidden">
				</view>
			...
			<view class="news" v-for="item in onlineList" @click="goResDetail(item,4)">
				<view class="new_img">
					<image :src="item.remark" alt="" style="width:100%;height: 70px;overflow: hidden">
				</view>
				<view class="new_title">{{ item.title }}</view>
			...
			<view class="news" v-for="item in offlineList" @click="goResDetail(item,5)">
				<view class="new_img">
					<image :src="item.remark" alt="" style="width:100%;height: 70px;overflow: hidden">
				</view>
				<view class="new_title">{{ item.title }}</view>
			...
			<view class="news" v-for="item in financeList" @click="goResDetail(item,6)">
				<view class="new_img">
					<image :src="item.remark" alt="" style="width:100%;height: 70px;overflow: hidden">
				</view>
				<view class="new_title">{{ item.title }}</view>
	...
	export default {
		...
		created() {
			...
			Promise.all([
				...
				this.onlineList = response[3].data
				this.offlineList = response[4].data
				this.financeList = response[5].data
				this.loading = false;
			})
		},
		methods: {
