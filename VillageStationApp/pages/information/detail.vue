<template>
	<view style="border-radius: 10px; background-color: white; margin:8px 15px; height: 100vh;">
		...
		<view class="news">
			...
			<view class="sub_content"><u-parse>{{item.content}}</u-parse></view>
		</view>
...
<script>
	...
	export default {
		...
		created() {
			...
			getCheckNewsDetails(this.item.id).then(response => {
