	...
	<view class="body">
		...
		<view class="main_context first_main_context" style="margin-top: 105px;">
			...
			<view v-if="policyList.length!=0">
				<view class="news" v-for="item in Array.from(policyList).slice(0,3)"
					@click="goNewsDetail(item)">
					<view class="new_img">
						<image :src="item.remark" class='new_img_img'>
					</view>
					<view class="new_title" style="margin-top: 20px;">
		...
		<view class="main_context first_main_context" style="margin-top: 10px;">
			...
			<view v-if="argriList.length!=0">
				<view class="news" v-for="item in Array.from(argriList).slice(0,3)"
					@click="goNewsDetail(item)">
					<view class="new_img">
						<image :src="item.remark" class='new_img_img'>
					</view>
