<template>
	<view>
		...
		<view @click="open">
			<u-button v-if="role === 'stationmaster' || role === 'science_specialist' || role === 'science_services_specialist' || role ==='finance_specialist' || role === 'science_services_specialist' || role ==='information_specialist'"
			class="custom-style" color="#00ae67 " type="primary" shape="circle"
