  ...
  <view class="normal-login-container">
    ...
    <view class="login-form-content">
      ...
      <view class="action-btn">
        <button @click="handleRegister()" class="register-btn cu-btn block bg-blue lg round" style="background-color:#00ae67;">注册</button>
      </view>
    </view>
    <view class="xieyi text-center">
      <text @click="handleUserLogin" class="text-color">使用已有账号登录</text>
    </view>
  </view>
</template>
