<template>
	<view class="body">
		...
		<!-- 介绍 -->
		<view class="content_container" style="font-size: 14px;color:#b0b0b0;margin-top: -60px; text-indent: 2em; line-height: 1.8; margin: 20px; margin-top: -10px;" >
