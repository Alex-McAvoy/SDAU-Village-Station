...
public class MinIoUtil {
    ...
    private String videoPath="video";//视频桶下目录
        ...
        for (MultipartFile file : multipartFile) {
            ...
            try {
                ...
                minioClient.putObject(PutObjectArgs.builder()
                        ...
                        .contentType("application/octet-stream") // Replace with your content type
                        .build()
                );
            } catch (Exception e) {
                e.printStackTrace();
    ...
    public String uploadVideo(String fileName,String filePath) {
        String newFileName = fileName.split("\\.")[0]+String.valueOf(DateUtils.dateTimeNow())+"."+filePath.split("\\.")[1];
        try {
