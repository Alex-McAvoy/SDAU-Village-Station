...
public class TbAskFreeController extends BaseController {
    ...
    public AjaxResult add(@RequestBody TbAskFree tbAskFree) {
        ...
        tbAskFree.setSort(deptId.toString());
    ...
    public AjaxResult getStationAskFreeInfo(@PathVariable("firstColumn") String firstColumn, @PathVariable("sort") String sort) {
        return success(tbAskFreeService.selectTbAskFreeBySort(firstColumn, sort));
    }
    ...
    public AjaxResult getLikeInfo(@PathVariable("query") String query) {
        return success(tbAskFreeService.selectTbAskFreeByLike(query));
    }
}
