...
public class TbFinanceController extends BaseController {
    ...
    public TableDataInfo getTbFinanceCategoryList(@PathVariable("category") String category) {
        startPage();
        List<TbFinance> list = tbFinanceService.selectTbFinanceCategoryList(category);
        return getDataTable(list);
    }
     ...
     */
    @PreAuthorize("@ss.hasPermi('system:finance:list:checked')")
    @GetMapping(value = "/category_tag_list/{category}/{sort}")
    public TableDataInfo getTbFinanceCategoryList(@PathVariable("category") String category,@PathVariable("sort") Long [] sort) {
        startPage();
        List<TbFinance> list = tbFinanceService.selectTbFinanceCategoryAndSortList(category,sort);
        return getDataTable(list);
    }
    ...
    public AjaxResult getTbFinanceCategoryListLimit(@PathVariable("category") String category, @PathVariable("num") Long num) {
        return success(tbFinanceService.selectTbFinanceCategoryListLimit(category, num));
    }
     ...
     */
    @PreAuthorize("@ss.hasPermi('system:finance:list:checked')")
    @GetMapping(value = "/category_list/{category}/{num}/{sort}")
    public AjaxResult getTbFinanceCategorySortListLimit(@PathVariable("category") String category, @PathVariable("num") Long num, @PathVariable Long[] sort) {
        return success(tbFinanceService.selectTbFinanceCategorySortListLimit(category, num,sort));
    }

    /**
     * 获取驿站id为sort的已审核的分类金融信息queryFinance
     *
     * @param category 分类
     * @param sort     驿站id
     * @return com.ruoyi.common.core.domain.AjaxResult
