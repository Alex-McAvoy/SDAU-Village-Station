...
public class TbNewsController extends BaseController {
    ...
    public AjaxResult add(@RequestBody TbNews tbNews) {
        ...
        tbNews.setSort(deptId.toString());
    ...
    @GetMapping("/get_news_idList/{idlist}")
    public List<TbNews> getNewsByIdList(@PathVariable("idlist")  Long[] idlist)
    {
        List<TbNews> list = tbNewsService.selectNewsByIdList(idlist);
        return  list;
    }
}
