...
public class TbNewsController extends BaseController {
    ...
    public TableDataInfo getTbNewsCategoryList(@PathVariable("category") String category) {
        startPage();
        List<TbNews> list = tbNewsService.selectTbNewsCategoryList(category);
        return getDataTable(list);
    }
    ...
    public TableDataInfo getTbNewsCategoryAndSortList(@PathVariable("category") String category,@PathVariable("sort") Long[] sort) {
        startPage();
        List<TbNews> list = tbNewsService.selectTbNewsCategoryAndSortList(category, sort);
        return getDataTable(list);
    }
    ...
    public AjaxResult getTbNewsCategoryListLimit(@PathVariable("category") String category, @PathVariable("num") Long num) {
        return success(tbNewsService.selectTbNewsCategoryListLimit(category, num));
    }
    ...
    public AjaxResult getTbNewsCategorySortListLimit(@PathVariable("category") String category,@PathVariable("num") Long num,@PathVariable("sort") Long[] sort) {
        return success(tbNewsService.selectTbNewsCategorySortListLimit(category, num, sort));
    }
    ...
    @PutMapping("/check")
    public AjaxResult editAudit(@RequestBody TbNews tbNews) {
