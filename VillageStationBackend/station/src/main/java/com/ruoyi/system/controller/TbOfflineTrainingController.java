...
public class TbOfflineTrainingController extends BaseController {
    ...
    public TableDataInfo auditSortList(@PathVariable("sort")Long [] sort) {
        startPage();
        List<TbOfflineTraining> list = tbOfflineTrainingService.selectTbOfflineTrainingSortAuditList(sort);
        return getDataTable(list);
    }
    ...
    public AjaxResult getTbOfflineTrainingListLimit(@PathVariable("num") Long num) {
        return success(tbOfflineTrainingService.selectTbOfflineTrainingListLimit(num));
    }
    ...
    public AjaxResult getTbOfflineTrainingSortListLimit(@PathVariable("num") Long num,@PathVariable("sort")Long[]sort) {
        return success(tbOfflineTrainingService.selectTbOfflineTrainingSortListLimit(num,sort));
    }
    ...
    public AjaxResult getTbOfflineTrainingCategoryList(@PathVariable("category") String category) {
