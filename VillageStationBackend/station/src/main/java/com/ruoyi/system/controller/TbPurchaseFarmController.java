...
public class TbPurchaseFarmController extends BaseController {
    ...
    public AjaxResult add(@RequestBody TbPurchaseFarm tbPurchaseFarm) {
        ...
        tbPurchaseFarm.setSort(deptId.toString());
    ...
    public AjaxResult getStationPurchaseFarmInfo(@PathVariable("firstColumn") String firstColumn, @PathVariable("secondColumn") String secondColumn, @PathVariable("sort") String sort) {
        return success(tbPurchaseFarmService.selectTbPurchaseFarmBySort(firstColumn, secondColumn, sort));
    }
    ...
    public AjaxResult getLikeInfo(@PathVariable("query") String query) {
        return success(tbPurchaseFarmService.selectTbPurchaseFarmByLike(query));
    }

    //通过id列表来查询
    @GetMapping("/get_farm_idlist/{idlist}")
    public List<TbPurchaseFarm> getNewsByIdList(@PathVariable("idlist")  Long[] idList)
    {
        List<TbPurchaseFarm> list = tbPurchaseFarmService.selectTbPurchaseFarmByIdList(idList);
        return  list;
    }
}
