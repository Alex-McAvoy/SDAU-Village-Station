...
public class TbQuestionController extends BaseController {
    ...
    public AjaxResult add(@RequestBody TbQuestion tbQuestion) {
        ...
        tbQuestion.setSort(deptId.toString());
     ...
     * @date 2023/10/11 11:12:59
     */
    @GetMapping(value = "/getListByColumn/{expertId}/{firstColumn}/{sort}")
    public AjaxResult getStationQuestionInfo(@PathVariable("expertId") Long expertId,@PathVariable("firstColumn") String firstColumn, @PathVariable("sort") String sort) {
        return success(tbQuestionService.selectTbQuestionBySort(expertId,firstColumn,sort));
    }
