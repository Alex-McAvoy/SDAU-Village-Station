...
public class TbRecommendProductsController extends BaseController {
    ...
    public AjaxResult add(@RequestBody TbRecommendProducts tbRecommendProducts) {
        ...
        tbRecommendProducts.setSort(deptId.toString());
    ...
    public AjaxResult getStationRecommendProductsInfo(@PathVariable("firstColumn") String firstColumn, @PathVariable("secondColumn") String secondColumn, @PathVariable("sort") String sort) {
        return success(tbRecommendProductsService.selectTbRecommendProductsBySort(firstColumn, secondColumn, sort));
    }
    ...
    public AjaxResult getLikeInfo(@PathVariable("query") String query) {
        return success(tbRecommendProductsService.selectTbRecommendProductsByLike(query));
    }

    //通过id列表来查询
    @GetMapping("/get_products_idlist/{idlist}")
    public List<TbRecommendProducts> getNewsByIdList(@PathVariable("idlist")  Long[] idList)
    {
        List<TbRecommendProducts> list = tbRecommendProductsService.selectTbRecommendProductsByIdList(idList);
        return  list;
    }
}
