...
{/**
    ...
    public List<TbFinance> selectTbFinanceByFirstSort(@Param("firstColumn")String firstColumn, @Param("secondColumn")String secondColumn, @Param("sort")String sort);
    ...
    public List<TbFinance>selectTbFinanceListByIdList(@Param("idList")Long[] idList);
}