...
public interface TbFinanceMapper {
     ...
     */
    public List<TbFinance> selectTbFinanceCategoryAndSortList(@Param("category") String category,@Param("sort")Long[] sort);
     ...
     */
    public List<TbFinance> selectTbFinanceCategoryListLimit(@Param("category") String category, @Param("num") Long num);
     ...
     * @date 2024/1/17 09:42:14
     */
    public List<TbFinance> selectTbFinanceCategorySortListLimit(@Param("category") String category, @Param("num") Long num,@Param("sort")Long[] sort);
