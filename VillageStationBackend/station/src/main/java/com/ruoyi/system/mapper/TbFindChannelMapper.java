...
public interface TbFindChannelMapper {
    ...
    List<TbFindChannel> selectTbFindChannelListBySort(@Param("firstColumn") String firstColumn, @Param("secondColumn")String secondColumn, @Param("sort")String sort);
    ...
    public List<TbFindChannel>selectTbFindChannelByIdList(@Param("idList")Long[] idList);
}