...
public interface TbLearnTechMapper 
{
    ...
    public List<TbLearnTech> selectTbLearnTechBySort(@Param("firstColumn")String firstColumn, @Param("secondColumn")String secondColumn, @Param("sort")String sort);
    ...
    public List<TbLearnTech>selectTbLearnTechByIdList(@Param("idList") Long[] idList);
}
