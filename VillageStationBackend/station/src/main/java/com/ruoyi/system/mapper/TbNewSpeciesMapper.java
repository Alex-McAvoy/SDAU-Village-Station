...
public interface TbNewSpeciesMapper 
{
    ...
    public List<TbNewSpecies> selectTbNewSpeciesBySort(@Param("firstColumn")String firstColumn, @Param("sort")String sort);
    ...
    public List<TbNewSpecies>selectTbNewSpeciesByIdList(@Param("idList")Long[] idList);
}
