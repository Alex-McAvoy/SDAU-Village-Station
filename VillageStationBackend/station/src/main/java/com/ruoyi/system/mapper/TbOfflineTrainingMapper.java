...
public interface TbOfflineTrainingMapper {
     ...
     */
    public List<TbOfflineTraining> selectTbOfflineTrainingSortAuditList(@Param("sort")Long [] sort);
     ...
     */
    public List<TbOfflineTraining> selectTbOfflineTrainingListLimit(@Param("num") Long num);
     ...
     * @date 2024/1/17 09:42:14
     */
    public List<TbOfflineTraining> selectTbOfflineTrainingSortListLimit(@Param("num") Long num,@Param("sort")Long[] sort);
     ...
     */
    public List<TbOfflineTraining> selectTbOfflineTrainingCategoryList(@Param("category") String category);
     ...
     * @date 2023/10/11 11:12:59
     */
    public List<TbOfflineTraining> selectTbOfflineTrainingCategorySortList(@Param("category") String category, @Param("sort") String sort);
     ...
     */
    public TbOfflineTraining selectTbOfflineTrainingById(@Param("id")Long id);
     ...
     */
    public int deleteTbOfflineTrainingById(@Param("id")Long id);
     ...
     * @date 2023/10/18 18:18:30
     */
    public int deleteTbOfflineTrainingByIds(@Param("ids")Long[] ids);
     ...
     */
    public List<TbOfflineTraining> selectTbOfflineTrainingByLike(@Param("query")String query);
     ...
     */
    public List<TbOfflineTraining> selectTbOfflineTrainingListByIds(@Param("ids") Long[] ids);
}
