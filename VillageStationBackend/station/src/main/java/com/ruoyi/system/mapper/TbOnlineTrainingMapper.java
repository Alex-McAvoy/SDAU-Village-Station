...
public interface TbOnlineTrainingMapper {
     ...
     */
    public List<TbOnlineTraining> selectTbOnlineTrainingSortAuditList(@Param("sort") Long[] sort);
     ...
     */
    public List<TbOnlineTraining> selectTbOnlineTrainingListLimit(@Param("num") Long num);
     ...
     * @date 2024/1/17 09:42:14
     */
    public List<TbOnlineTraining> selectTbOnlineTrainingSortListLimit(@Param("num") Long num, @Param("sort")Long[] sort);
