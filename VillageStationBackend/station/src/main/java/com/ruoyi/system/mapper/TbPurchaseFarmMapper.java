...
public interface TbPurchaseFarmMapper 
{
    ...
    public List<TbPurchaseFarm> selectTbPurchaseFarmBySort(@Param("firstColumn")String firstColumn, @Param("secondColumn")String secondColumn, @Param("sort")String sort);
    ...
    public List<TbPurchaseFarm>selectTbPurchaseFarmByIdList(@Param("idList")Long[] idList);
}
