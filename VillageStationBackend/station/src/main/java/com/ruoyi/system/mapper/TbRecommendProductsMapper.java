...
public interface TbRecommendProductsMapper 
{
    ...
    public List<TbRecommendProducts> selectTbRecommendProductsBySort(@Param("firstColumn")String firstColumn, @Param("secondColumn")String secondColumn, @Param("sort")String sort);
    ...
    public List<TbRecommendProducts>selectTbRecommendProductsByIdList(@Param("idList")Long[] idList);
}
