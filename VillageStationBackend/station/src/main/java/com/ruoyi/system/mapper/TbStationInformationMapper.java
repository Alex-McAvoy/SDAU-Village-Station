 ...
 **/
public interface TbStationInformationMapper {
    /**
     * 查询驿站信息列表
     *
     ...
     */
    public List<TbStationInformation> selectTbStationInformationListByStationId(@Param("stationId") Long stationId);
     ...
     * @date 2023/10/9 15:32:34
     */
    public List<TbStationInformation> selectTbStationInformationUnauditedListByStationId(@Param("stationId") Long stationId);
     ...
     */
    public List<TbStationInformation> selectTbStationInformationCategoryList(@Param("category") String category);
     ...
     */
    public List<TbStationInformation> selectTbStationInformationCategoryListLimit(@Param("category") String category, @Param("num") Long num);
     ...
     * @date 2023/10/11 11:12:59
     */
    public List<TbStationInformation> selectTbStationInformationCategorySortList(@Param("category") String category, @Param("sort") String sort);
     ...
     */
    public List<TbStationInformation> selectTbStationInformationCategorySortListLimit(@Param("category") String category, @Param("num") Long num, @Param("sort") String sort);
     ...
     */
    public TbStationInformation selectTbStationInformationById(@Param("id") Long id);
     ...
     */
    public int deleteTbStationInformationByStationInformationId(@Param("id") Long id);
     ...
     */
    public int deleteTbStationInformationByStationInformationIds(@Param("ids") Long[] ids);
     ...
     */
    public List<TbStationInformation> selectStationInformationByLike(@Param("query")String query);
     ...
     */
    public List<TbStationInformation> selectStationInformationListByIds(@Param("ids") Long[] ids);
}
