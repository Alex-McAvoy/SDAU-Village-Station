...
public interface ITbFindChannelService 
{
    ...
    List<TbFindChannel> selectTbFindChannelListBySort(String firstColumn, String secondColumn,String sort);
    ...
    //通过id列表来查询
    List<TbFindChannel> selectTbFindChannelByIdList(Long[] idList);
}
