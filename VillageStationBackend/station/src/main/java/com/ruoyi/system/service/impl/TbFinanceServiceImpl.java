...
public class TbFinanceServiceImpl implements ITbFinanceService {
    ...
    @Override
    public List<TbFinance> selectTbFinanceByFirstSort(String firstColumn, String secondColumn, String sort) {
        return tbFinanceMapper.selectTbFinanceByFirstSort(firstColumn, secondColumn, sort);
    }
    ...
    //通过id列表来查询
    @Override
    public List<TbFinance> selectTbFinanceListByIdList(Long[] idList) {
        return tbFinanceMapper.selectTbFinanceListByIdList(idList);
    }
}