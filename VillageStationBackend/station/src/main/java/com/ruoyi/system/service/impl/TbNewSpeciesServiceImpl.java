...
public class TbNewSpeciesServiceImpl implements ITbNewSpeciesService {
    ...
    @Override
    public List<TbNewSpecies> selectTbNewSpeciesBySort(String firstColumn, String sort) {
        return tbNewSpeciesMapper.selectTbNewSpeciesBySort(firstColumn, sort);
    }
    ...
    public int subLikes(TbNewSpecies tbNewSpecies) {
        return tbNewSpeciesMapper.subLikes(tbNewSpecies);
    }

    @Override
    public int subCollect(TbNewSpecies tbNewSpecies) {
        return tbNewSpeciesMapper.subCollect(tbNewSpecies);
    }

    @Override
    public List<TbNewSpecies> selectTbNewSpeciesByLike(String query) {
        return tbNewSpeciesMapper.selectTbNewSpeciesByLike(query);
    }

    //通过id列表来查询
    @Override
    public List<TbNewSpecies> selectTbNewSpeciesByIdList(Long[] idList) {
        return tbNewSpeciesMapper.selectTbNewSpeciesByIdList(idList);
    }
