...
public class TbOfflineTrainingServiceImpl implements ITbOfflineTrainingService {
    ...
    public List<TbOfflineTraining> selectTbOfflineTrainingSortAuditList(Long[] sort) {
        return tbOfflineTrainingMapper.selectTbOfflineTrainingSortAuditList(sort);
    }
    ...
    public List<TbOfflineTraining> selectTbOfflineTrainingListLimit(Long num) {
        return tbOfflineTrainingMapper.selectTbOfflineTrainingListLimit( num);
    }
    /**
     * 获取num条已审核的分类、标签信息
     * @param num 获取数量
    ...
    public List<TbOfflineTraining> selectTbOfflineTrainingSortListLimit(Long num,Long[] sort) {
        return tbOfflineTrainingMapper.selectTbOfflineTrainingSortListLimit( num, sort);
    }
