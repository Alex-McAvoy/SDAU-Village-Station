...
public class TbOnlineTrainingServiceImpl implements ITbOnlineTrainingService {
     ...
     */
    @Override
    public List<TbOnlineTraining> selectTbOnlineTrainingSortAuditList(Long [] sort) {
        return tbOnlineTrainingMapper.selectTbOnlineTrainingSortAuditList(sort);
    }
     ...
     */
    @Override
    public List<TbOnlineTraining> selectTbOnlineTrainingListLimit(Long num) {
        return tbOnlineTrainingMapper.selectTbOnlineTrainingListLimit( num);
    }
    /**
     * 获取num条已审核的分类、标签信息
     * @param num 获取数量
     ...
     */
    @Override
    public List<TbOnlineTraining> selectTbOnlineTrainingSortListLimit(Long num,Long[]sort) {
        return tbOnlineTrainingMapper.selectTbOnlineTrainingSortListLimit( num,sort);
    }
