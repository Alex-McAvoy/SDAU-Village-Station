...
public class TbRecommendProductsServiceImpl implements ITbRecommendProductsService {
    ...
    public List<TbRecommendProducts> selectTbRecommendProductsBySort(String firstColumn, String secondColumn, String sort) {
        return tbRecommendProductsMapper.selectTbRecommendProductsBySort(firstColumn, secondColumn, sort);
    }
    ...
    public List<TbRecommendProducts> selectTbRecommendProductsByLike(String query) {
        return tbRecommendProductsMapper.selectTbRecommendProductsByLike(query);
    }

    //通过id列表来查询
    @Override
    public List<TbRecommendProducts> selectTbRecommendProductsByIdList(Long[] idList) {
        return tbRecommendProductsMapper.selectTbRecommendProductsByIdList(idList);
    }
}