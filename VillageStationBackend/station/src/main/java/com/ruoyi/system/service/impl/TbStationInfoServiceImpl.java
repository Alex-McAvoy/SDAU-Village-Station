...
public class TbStationInfoServiceImpl implements ITbStationInfoService {
    ...
    public List<TbStationInfo> selectTbStationInfoBySort(String firstColumn, String sort) {
        return tbStationInfoMapper.selectTbStationInfoBySort(firstColumn, sort);
    }
    ...
    public List<TbStationInfo> selectTbStationInfoByLike(String query) {
        return tbStationInfoMapper.selectTbStationInfoByLike(query);
    }

    //通过id列表来查询
    @Override
    public List<TbStationInfo> selectTbStationInfoByIdList(Long[] idList) {
        return tbStationInfoMapper.selectTbStationInfoByIdList(idList);
    }
}
